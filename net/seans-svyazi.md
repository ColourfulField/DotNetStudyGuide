Сессия - это промежуток времени, охватывающий работу пользователя в интернете с момента отправки первого запроса на сервер до отправки последнего запроса.
