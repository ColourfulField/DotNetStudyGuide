...
* ADO.NET - не совсем ORM, скорее, инструмент, встроенный в .NET. Этот инструмент позволяет отправлять запросы к SQL-серверу и получать от него ответы, которые в результате конвертируются в C\#-классы.
